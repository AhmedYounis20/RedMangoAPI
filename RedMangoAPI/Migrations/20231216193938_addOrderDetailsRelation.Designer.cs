...
namespace RedMangoAPI.Migrations
{
    ...
    [Migration("20231216193938_addOrderDetailsRelation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RedMangoAPI.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedMangoAPI.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("RedMangoAPI.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedMangoAPI.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedMangoAPI.CartItem", b =>
                {
                    b.HasOne("RedMangoAPI.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RedMangoAPI.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("RedMangoAPI.OrderDetails", b =>
                {
                    ...
                    b.HasOne("RedMangoAPI.OrderHeader", null)
            ...
            modelBuilder.Entity("RedMangoAPI.OrderHeader", b =>
                {
                    b.HasOne("RedMangoAPI.ApplicationUser", "User")
                        .WithMany()
